...
from aiclass.droneRoom import DroneRoom, Drone, Velocity
...
if __name__ == "__main__":
    ...
    room = DroneRoom(length=room_length, width=room_width, height=room_height, num_obstacles=num_obstacles, num_asteroids=num_asteroids, is_simulated=True)
