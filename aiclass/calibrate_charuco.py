# From: https://github.com/kyle-elsalhi/opencv-examples/blob/master/CalibrationByCharucoBoard/CalibrateCamera.py
# modified by Amy to match the parameters we want
...
# note this relies on the marker_id 1 board we generate in gen_charuco_markers
dict_5x5x5 = aruco.Dictionary_create(nMarkers=25, markerSize=5, randomSeed=1)
board_5x5x5 = aruco.CharucoBoard_create(squaresX=5, squaresY=5, squareLength=0.06,
                                         markerLength=0.04, dictionary=dict_5x5x5)
...
images = glob.glob('./charuco_image_*.png')
